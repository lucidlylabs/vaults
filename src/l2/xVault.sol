...
import {xVaultStorage} from "./xVaultStorage.sol";

contract xVault is xVaultStorage, IXERC20, AccessManagedUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    /**
    ...
    function initialize(address accessManager) public initializer {
        ...
        __ERC20_init("xVault", "xVault");
        __ERC20Permit_init("xVault");
    }
    ...
    function setLockbox(address lockboxAddress) external restricted {
        xVault storage $ = _getXVaultStorage();
