...
contract PoolAdd is Test {
    ...
    function setUp() public {
        ...
        vault = new MasterVault(address(poolToken), "XYZ Vault Share", "XYZ-VST", 100, jake, jake);
    ...
    function testAddLiquidityMultiple() public {
        ...
        for (uint256 i = 0; i < numTokens; i++) {
            ...
            amounts1[i] = total1 * weights[i] / rp.rate(token);
            amounts2[i] = total2 * weights[i] / rp.rate(token);
